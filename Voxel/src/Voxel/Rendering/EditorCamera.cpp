...
namespace Voxel {
	...
	EditorCamera::EditorCamera(float fov, float aspectRatio, glm::vec2 clippingPlane)
		: m_FOV(fov), m_AspectRatio(aspectRatio), m_ClippingPlane(clippingPlane),
		Camera(glm::perspective(glm::radians(fov), aspectRatio, m_ClippingPlane.x, m_ClippingPlane.y))
	{
		UpdateView();
	}
